...
import { api, Trip, Expense, TripMember } from '@/lib/api';
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800">
          ...
          {activeTab === 'fuel' && (
            <div className="p-6">
              <h2 className="text-xl font-semibold text-black dark:text-white mb-4">Gorivo</h2>
              <p className="text-zinc-600 dark:text-zinc-400">Funkcionalnost goriva u izradi...</p>
            </div>
          )}
